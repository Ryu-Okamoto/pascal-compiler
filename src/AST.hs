...
data    AIfStatement                  = AIfStatement AExpression ACompoundStatement AElseStatement
...
data    AFactor                       = AVariableReference AVariable | AConstantReference AConstant | ARecursion AExpression | ANegation AFactor
...
data    AConstant                     = AIntegerLiteral AUnsignedInteger | AStringLiteral AString | ABooleanLiteral ABoolean
