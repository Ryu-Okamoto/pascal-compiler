...
showVariableDeclaration n (VariableDeclaration (Just variableDeclarationSequenceList)) = makeIndent n ++ "VariableDeclaration\n" ++ showVariableDeclarationSequence (n + 1) variableDeclarationSequenceList 
showVariableDeclaration n (VariableDeclaration Nothing) = makeIndent n ++ "VariableDeclaration\n"
...
showParameter n (Parameter (Just parameterSequence)) = makeIndent n ++ "Parameter\n" ++ showParameterSequence (n + 1) parameterSequence
showParameter n (Parameter Nothing) = makeIndent n ++ "Parameter\n"
...
showStatementSequence n (StatementSequence statement statementList) = makeIndent n ++ "StatementSequence\n" ++ showStatement (n + 1) statement ++ concatMap (showStatement (n + 1)) statementList 
...
showBasicStatement n (Assignment assignStatement) = makeIndent n ++ "BasicStatement (Assignment)\n" ++ showAssignStatement (n + 1) assignStatement 
...
showAssignStatement :: Int -> AssignmentStatement -> String
showAssignStatement n (AssignmentStatement leftSide expression) = makeIndent n ++ "AssignmentStatement\n" ++ showLeftSide (n + 1) leftSide ++ showExpression (n + 1) expression 
